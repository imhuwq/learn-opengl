...
int main() {
    ...
    Shader object_shader("shaders/chapter_02/materials/object.vert", "shaders/chapter_02/materials/object.frag");
    Shader light_shader("shaders/chapter_02/materials/light.vert", "shaders/chapter_02/materials/light.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        object_shader.Use();
        object_shader.SetVec3("material.ambient", glm::vec3(1.0f, 0.5f, 0.31f));
        object_shader.SetVec3("material.diffuse", glm::vec3(1.0f, 0.5f, 0.31f));
